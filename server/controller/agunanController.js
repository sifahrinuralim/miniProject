...
class agunanController{
    ...
    static addAgunan (req,res){
        ...
        const {Id_user,id_form_agunan,jenis_agunan,luas_tanah,luas_bangunan,kondisi_bangunan,
            status_kepemilikan,nama_sertifikat,nomor_sertifikat,masa_berlaku_sertifikat,
            nomor_spr,alamat_agunan,rt,rw,provinsi_agunan,kab_kota_agunan,kecamatan_agunan,kelurahan_agunan,kode_pos_agunan} = req.body
        ...
        if (!Id_user||!id_form_agunan||!jenis_agunan||!luas_tanah||!luas_bangunan ||!kondisi_bangunan
            ...
            const data = data_agunan.create ({Id_user,id_form_agunan,jenis_agunan,luas_tanah,luas_bangunan,kondisi_bangunan,
                status_kepemilikan,nama_sertifikat,nomor_sertifikat,masa_berlaku_sertifikat,
                nomor_spr,alamat_agunan,rt,rw,provinsi_agunan,kab_kota_agunan,kecamatan_agunan,kelurahan_agunan,kode_pos_agunan})
            .then((data) => {
                res.status(201).json({                    
