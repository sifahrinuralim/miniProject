...
module.exports = (sequelize, DataTypes) => {
  ...
  data_pengajuan.init({
    ...
    total_plafond: DataTypes.INTEGER,
    waktu_pembiayaan: DataTypes.INTEGER,
    jenis_penjual_kendaraan: DataTypes.STRING,
    nama_penjual_kendaraan: DataTypes.STRING,
    nilai_spr_kendaraan: DataTypes.INTEGER,
    no_telepon_penjual_kendaraan: DataTypes.INTEGER,
    uang_muka_kendaraan: DataTypes.INTEGER,
    jenis_penjual_properti: DataTypes.STRING,
    nama_penjual_properti: DataTypes.STRING,
    nilai_spr_properti: DataTypes.INTEGER,
    no_telepon_penjual_properti: DataTypes.INTEGER,
    uang_muka_properti: DataTypes.INTEGER,
    ...
    nilai_pelunasan_take_over: DataTypes.INTEGER,
    plafond_top_up: DataTypes.INTEGER
  }, {
    sequelize,
