...
module.exports = (sequelize, DataTypes) => {
  ...
  data_diri_keluarga.init({
    ...
    nik_pemohon: DataTypes.INTEGER,
    npwp_pemohon: DataTypes.INTEGER,
    ...
    nomor_handphone_1: DataTypes.INTEGER,
    nomor_handphone_2: DataTypes.INTEGER,
    nomor_rumah: DataTypes.INTEGER,
    email: DataTypes.STRING,
    nama_pasangan: DataTypes.STRING,
    tempat_lahir_pasangan: DataTypes.STRING,
    tanggal_lahir_pasangan: DataTypes.DATE,
    nik_pasangan: DataTypes.INTEGER,
    npwp_pasangan: DataTypes.INTEGER,
    pekerjaan_pasangan: DataTypes.STRING,
    no_telepon_pasangan: DataTypes.INTEGER,
