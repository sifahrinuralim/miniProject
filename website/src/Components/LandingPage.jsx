    ...
    <>
      ...
      <div>
        ...
        <div className="caption">
          ...
          <p className="caption2">Terdapat dua pilihan akad yaitu Murabahah (Jual Beli) atau Musyarakah Mutanaqishah (Kerjasama Sewa).</p>
        ...
        <div className="box">
          ...
          <div className="boxtext1">
            <h5 className="text">Berlaku untuk nasabah baru dan nasabah eksisting Bank  Muamalat.</h5>
          </div>
          ...
          <div className="boxtext3">
            <h5 className="text" >Angsuran tetap hingga akhir pembiayaan sesuai perjanjian dengan akad Murabahah.</h5>
          </div>

          <div className="boxtext4">
            <h5 className="text">Bebas memilih skema dengan Angsuran Super Ringan atau Angsuran Fix & Fix.</h5>
          </div>

          <div className="boxtext5">
            <h5 className="text">Percepatan proses, persyaratan simpel, uang muka ringan untuk nasabah loyal. </h5>
          </div>
          ...
          <div className="boxtext8">
            <h5 className="text">Dapat diajukan dengan sumber penghasilan  bersama atau joint income.</h5>
          </div>
        </div>
        ...
        <div className="syarat">
          ...
          <ol type="1">
            ...
            <li>Usia maksimal saat jatuh tempo pembiayaan bagi pegawai 55 tahun atau belum pensiun serta 60 tahun untuk wiraswasta.</li>
            ...
            <ol type="a">
              ...
              <li>Fotocopy NPWP</li>
              <li>Asli slip gaji & surat keterangan kerja (untuk pegawai/karyawan)</li>
              <li>Fotocopy mutasi rekening buku tabungan/statement giro 3 bulan terakhir</li>
