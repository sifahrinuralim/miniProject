...
const App = () => {
  ...
  const selectOneFile = async () => {
    ...
    try {
      ...
      const hasil = JSON.stringify(res);
      const myObj = JSON.parse(hasil);
      console.log('res : ' + hasil);
      console.log('URI : ' + alert(myObj.uri));
      console.log('Type : ' + myObj.type);
      console.log('File Name : ' + myObj.name);
      console.log('File Size : ' + myObj.size);
