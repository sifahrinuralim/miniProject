        ...
        <ScrollView>
          ...
          <View style={lpstyles.cardCont}>
            ...
            <View style={lpstyles.cardBody}>
              <View>
                <Text style={lpstyles.textBody}>Mohon lakukan pengecekan sebelum menekan tombol “Ajukan KPR” untuk pengajuan kredit kepemilikan properti Anda secara seksama, informasi yang telah Anda isi akan kami gunakan untuk menindak lanjuti  pengajuan Anda.    </Text>
              </View>
            </View>
          </View>
