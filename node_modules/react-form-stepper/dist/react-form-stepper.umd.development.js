(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-jss'), require('clsx'), require('color')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-jss', 'clsx', 'color'], factory) :
  (global = global || self, factory(global['react-form-stepper'] = {}, global.React, global.reactJss, global.clsx, global.Color));
}(this, (function (exports, React, reactJss, clsx, Color) { 'use strict';
  ...
  var Step = function Step(_ref) {
    ...
    return React.createElement(StepContext.Provider, {
      value: contextValue
    }, index !== 0 && (hideConnectors === 'inactive' && (active || completed) || hideConnectors !== true && hideConnectors !== 'inactive') && React.createElement(Connector, null), React.createElement("div", {
...
//# sourceMappingURL=react-form-stepper.umd.development.js.map
