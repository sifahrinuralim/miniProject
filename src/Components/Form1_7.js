        ...
        <>
            <div className="wrapper">
                <div type="form" className="basicForm">
                    ...
                    <label className="basicLabel" htmlFor="skema">Memiliki Pembiayaan di Bank / Lembaga Keuangan Lain</label>
                        ...
                        <input className="basicInput" placeholder="Masukan Jenis Pembiayaan"></input>

                        <label className="basicLabel" >Nama Kreditur</label>
                        <input className="basicInput" placeholder="Masukan Nama Kreditur"></input>
