        ...
        <>
            <div className="wrapper">
                <div type="form" className="basicForm">
                    ...
                    <label className="basicLabel" for="Pembiayaan">Jenis Pekerjaan</label>
                        <select className="dropdownSelect" placeholder="Pilih Jenis Pekerjaan">
                    ...
                    <input className="basicInput" placeholder="Masukkan Nama Perusahaan"></input>
                    ...
                    <select className="dropdownSelect">
                        <option value="" disabled selected hidden>Pilih Kategori Instansi</option>
                        <option value="Pemerintahan">Pemerintahan</option>
                        <option value="BUMN">BUMN</option>
                        <option value="TNI/Polri">TNI/Polri</option>
                        <option value="Wiraswasta/Profesional">Wiraswasta/Profesional</option>
                        ...
                        <div className="halfHalf">
                            <div className="wrapperHalf">
                                ...
                                <div className="inputWithIconRightWrapper">
                                    <input className="inputWithIconRight" placeholder="1" type="number" min="1"/>
                    ...
                    <input className="basicInput" placeholder="Masukan Jumlah Karyawan" type="number"></input>

                    <label className="basicLabel">Pendapatan Per Bulan</label>
                    <div className="inputWithIconLeftWrapper">
                        <input className="inputWithIconLeft" type="number" min="1" placeholder="30.000.000"/>
                        <label className="iconLeft">Rp</label>
                    </div>

                    <label className="basicLabel" htmlFor="skema">Status Pekerjaan</label>
                    ...
                    <label className="basicLabel" htmlFor="skema">Pembayaran Gaji</label>
                    <div className="radioWrapper">
                        <label className="radioContainer">
                            <label className="radioLabel"> Transfer Bank Muamalat </label>
                            <input value="Transfer Bank Muamalat" type="radio" name="radio"></input>
                            <span className="checkmark"></span>
                        </label>
                        <label className="radioContainer"> 
                        <label className="radioLabel"> Transfer Bank Lain </label>
                            <input value="Transfer Bank Lain" type="radio" name="radio"></input>
                            <span className="checkmark"></span>
                        </label>
                    </div>

                    <label className="basicLabel" >Alamat Kantor atau Tempat Usaha</label>
                    <input className="basicInput" placeholder="Masukan Alamat Kantor atau Tempat Usaha" type="number"></input>

                    <label className="basicLabel" >Bidang Usaha</label>
                    <input className="basicInput" placeholder="Masukan Bidang Usaha" type="number"></input>

                    <label className="basicLabel">Nomor Telepon Kantor</label>
                    <div className="inputWithIconLeftWrapper">
                        <input className="inputWithIconLeft" type="number" min="1" placeholder="81234567890"/>
                    ...
                    <div class="radioWrapper">
                        ...
                        <div className="halfHalf">
                            <div className="wrapperHalf">
                                ...
                                <input className="basicInput" placeholder="example@email.com" type="email"></input>
                            </div>
                        </div>  
                    </div>
                    ...
                    <div class="radioWrapper">
                        <div className="halfHalf">
                            <div className="wrapperHalf">
                                <label className="basicLabel">Nomor Telepon Atasan Langsung</label>
                                <div className="inputWithIconLeftWrapper">
                                    <input className="inputWithIconLeft" type="number" placeholder="81234567899"/>
                                    <label className="iconLeft">+62</label>
                                </div>
                        ...
                        <div className="halfHalf">
                            <div className="wrapperHalf">
                                <label className="basicLabel">Alamat Email Atasan Langsung</label>
                                <input className="basicInput" placeholder="example@email.com" type="email"></input>
                            </div>
                        </div>  
                    </div>
